...
const services = [
  {
    icon: "/images/s_2.png",
    title: "Boost Your Google Ratings",
    description:
   ...
   justify-between py-6 px-4 md:px-8 mx-6"
      >
        ...
        <div className="flex items-center gap-x-4">
          <a href="tel:8421705719" className="hidden lg:flex">
  ...
  duration-200
      ...
      <main className="md:pb-10">
        <div className="md:px-0 mx-6 xl:w-4/5 2xl:w-[68%] md:mx-auto mt-14">
          ...
          <p
           ...
           text-xl md:text-2xl my-6 md:my-10 md:w-4/5 mx-auto text-white"
          >
   ...
   md:px-16
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 items-center text-left md:justify-items-center md:mx-auto mt-10 md:mt-16">
            <BoxReveal boxColor={"#3b82f6"} duration={0.5}>
              <p className="md:text-xl font-semibold flex gap-x-2 md:gap-x-4 items-center text-white">
                <PiCheckBold className="text-xl text-white" />
                Google Ratings
              </p>
            </BoxReveal>
            <BoxReveal boxColor={"#3b82f6"} duration={0.5}>
          ...
          <div className="md:flex items-center justify-between gap-y-4 my-10 gap-x-28 mx-auto">
            <div className="md:w-2/5">
              ...
              <div className="flex my-6 gap-x-5 w-full">
                <div>
                  <h1 className="text-[#dbd704] text-3xl md:text-5xl">
                ...
                <div className="flex-1 min-w-0">
                  <h1 className="text-[#dbd704] text-3xl md:text-5xl whitespace-nowrap overflow-hidden">
      ...
      <Element name="process">
        ...
        <h1 className="text-white text-3xl md:text-5xl md:text-center font-medium flex items-center gap-x-2 mx-auto justify-center">
        Our{" "}
            <span className="text-[#dbd704] flex gap-x-1 items-center">
              {" "}
              <Image
        ...
        <main className="md:flex items-center justify-center space-y-6 md:space-y-0 md:gap-x-20 xl:w-4/5 2xl:w-[68%] mx-auto px-6 md:px-0">
          ...
          <div className="flex flex-col gap-y-5 md:w-1/2">
            <h1 className="text-lg md:text-2xl text-white ">
              &quot;We&apos;ve been working with DIGIChain for over 2 years and
      ...
      <footer className="bg-[#fafafa] py-10  px-6 md:px-0 md:mx-auto border-t">
        ...
        <div className="flex md:justify-center gap-x-4 mt-10">
          © 2025 DigiChain. All Rights Reserved.
